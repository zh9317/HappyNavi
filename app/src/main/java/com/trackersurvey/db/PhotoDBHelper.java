...
public class PhotoDBHelper {
    ...
    public int insertEvent(InterestMarkerData event) {
        ...
        try {
            ...
            values.put(COLUMNS_UE[10], event.getTraceNo());
            values.put(COLUMNS_UE[11], event.getPicCount());
            ...
            values.put(COLUMNS_UE[18], event.getCompanionCount());
            values.put(COLUMNS_UE[19], event.getRelationship());

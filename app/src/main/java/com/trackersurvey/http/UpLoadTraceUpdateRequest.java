...
public class UpLoadTraceUpdateRequest extends HttpUtil {
    ...
    public UpLoadTraceUpdateRequest(String _timestamp, String token, String deviceID, String traceInfo) {
    ...
    public RequestBody parameter() {
        ...
        Log.i("LOGDEMO", "结束记录footprint2018"+"_appkey"+_appkey+"_timestamp"+_timestamp+"Token"+Token
